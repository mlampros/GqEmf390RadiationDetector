...
ggplot(data=inp_data, aes(x=Date_Time, y=inp_data[[glue::glue("{radiation_method}")]], fill=Value)) +
...
```{r plotly-EMF-figure, eval = TRUE, echo = FALSE, warning = F, message = F, dev = "png", fig.height = 8, fig.width = 10}

# Vizualization EMF

GGPLOT(inp_data = dat_all, radiation_method = 'EMF')

```


```{r plotly-EF-figure, eval = TRUE, echo = FALSE, warning = F, message = F, dev = "png", fig.height = 8, fig.width = 10}

# Vizualization EF

GGPLOT(inp_data = dat_all, radiation_method = 'EF')

```


```{r plotly-RF-figure, eval = TRUE, echo = FALSE, warning = F, message = F, dev = "png", fig.height = 8, fig.width = 10}

# Vizualization RF

GGPLOT(inp_data = dat_all, radiation_method = 'RF_pw_sqcm')
...
```{r Leaflet-Map, eval = TRUE, echo = FALSE, warning = F, message = F, dev = "png", fig.height = 6, fig.width = 8}
...
saveWidgetFix(widget = lft, file = 'my_location.html', selfcontained = TRUE)
...
[Click here to view the Location (Zografou, Athens, Greece) on Browser](man/figures/my_location.html)

<br>

![](man/figures/README-Leaflet-Map-1.png)
<br>
